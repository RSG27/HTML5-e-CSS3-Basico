...
<p>
Neste exercício, busquei fazer um formulário simples para cadastro. Para isso, foram utilizadas as tags "form" para criação do formulário, "label" para representar uma legenda para um item em uma interface de usuário,"input" para criação dos campos a serem preenchidos, "textarea" para preenchimento de textos, "select" para seleção de uma lista de informações e "option" para as opções do campo de seleção. Quando preenchemos todos os campos do formulário e enviamos essas informações para a página de login, o método GET nos mostra na URI do navegador quais são elas.
</p>
